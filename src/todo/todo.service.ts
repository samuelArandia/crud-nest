...
export class TodoService {
  ...
  private todos: Todo[] = [
    ...
    {id: 2, description: 'Gema del Tiempo', done: false},
    {id: 3, description: 'Gema del Espacio', done: false},
    {id: 4, description: 'Gema del poder', done: false},
    {id: 5, description: 'Gema del realidad', done: false},
    {id: 6, description: 'Gema del mente', done: true},
  ]; 
